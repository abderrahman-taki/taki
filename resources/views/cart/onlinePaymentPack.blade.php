            ...
            <div class="row">
                <div class="col">
                    <div class="section_title ">
                        <h3>The price to pay is : {{$order->pack->price}} MAD</h3>
                        <h3>The pack you choose is : {{$order->pack->title}} MAD</h3>
                    </div>
                </div>
            </div>
            <div class="row">
 ...
 createOrder: function(data, actions) {
     ...
     onApprove: function(data, actions) {
         return actions.order.capture().then(function(details) {
             ...
             location.replace("{{route('paymentSuccessPack',['language'=>app()->getLocale(),'orderId'=>$order->id])}}");
         });
     }
