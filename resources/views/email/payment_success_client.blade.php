                          ...
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                ...
                                Hi, {{$client->client->first_name}} {{$client->client->last_name}}<br />
                                Payment : Online <br />
                                Price:  {{$client->total_price}} MAD<br /><br />
                                <span class="header-sm">List of Meals</span><br />
                                @foreach ($orders as $order)
                                    {{$order->cart->food->title}}: {{$order->cart->food->price}} x{{$order->cart->prod_qty}}
                                @endforeach
                              </td>
                            </tr>
                          </table>
