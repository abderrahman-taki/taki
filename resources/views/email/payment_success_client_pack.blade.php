      ...
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Pack Details</span><br />
                                Hi, {{$client->first_name}} {{$client->last_name}}<br />
                                Pack : {{$order->pack->title}} <br />
                                Price:  {{$order->pack->price}} MAD
                              </td>
                            </tr>
                          </table>
                        </td>
          ...
          <tr>
            <td class="button">
              <div>
                <a  href="http://127.0.0.1:8000/ourPacks/{{app()->getLocale()}}/{{$order->pack->slug}}"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">See the Pack On Our Website</a></div>
            </td>
          </tr>
